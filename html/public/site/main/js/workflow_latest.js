...
function workflow_settings(_boxType,id)
{
	_popupElementId = "";
	_popupElementId = id;
	var links = _settings['links'];
	var isExists = false;
	for(var key in links)
	{
		if(key > 0)
		{
			if(links[key].to == _popupElementId)
			{
				isExists = true;
			}
		}
	...
	switch(_boxType)
	{
		...
		if(false === isExists)
		{
			...
			{
				$('#workflow_out_sdiChannelPopup #workflow_out_sdi_encoders').parent().parent().hide();
			}
		}
		else if(true === isExists)
		{
			if($('#workflow_out_sdiChannelPopup #workflow_out_sdi_encoders').length > 0)
			{
				$('#workflow_out_sdiChannelPopup #workflow_out_sdi_encoders').parent().parent().show();
			}
		} 	
		$('#workflow_out_sdiChannelPopup').modal('show');
		break;
		...
		if(false === isExists)
		{
			...
			{
				$('#workflow_out_ndiChannelPopup #workflow_out_ndi_encoders').parent().parent().hide();
			}
		}
		else if(true === isExists)
		{
			if($('#workflow_out_ndiChannelPopup #workflow_out_ndi_encoders').length > 0)
			{
				$('#workflow_out_ndiChannelPopup #workflow_out_ndi_encoders').parent().parent().show();
			}
		}
		$('#workflow_out_ndiChannelPopup').modal('show');
		break;
		...
		if(false === isExists)
		{
			...
			{
				$('#workflow_out_rtmpChannelPopup #workflow_out_rtmp_encoders').parent().parent().hide();
			}
		}
		else if(true === isExists)
		{
			if($('#workflow_out_rtmpChannelPopup #workflow_out_rtmp_encoders').length > 0)
			{
				$('#workflow_out_rtmpChannelPopup #workflow_out_rtmp_encoders').parent().parent().show();
			}
		}
		$('#workflow_out_rtmpChannelPopup').modal('show');
		break;
		...
		if(false === isExists)
		{
			...
			{
				$('#workflow_out_rtpChannelPopup #workflow_out_rtp_encoders').parent().parent().hide();
			}
		}
		else if(true === isExists)
		{
			if($('#workflow_out_rtpChannelPopup #workflow_out_rtp_encoders').length > 0)
			{
				$('#workflow_out_rtpChannelPopup #workflow_out_rtp_encoders').parent().parent().show();
			}
		}
		$('#workflow_out_rtpChannelPopup').modal('show');		
		break;
		...
		if(false === isExists)
		{
			...
			{
				$('#workflow_out_udpChannelPopup #workflow_out_udp_encoders').parent().parent().hide();
			}
		}
		else if(true === isExists)
		{
			if($('#workflow_out_udpChannelPopup #workflow_out_udp_encoders').length > 0)
			{
				$('#workflow_out_udpChannelPopup #workflow_out_udp_encoders').parent().parent().show();
			}
		}
		$('#workflow_out_udpChannelPopup').modal('show');
		break;
		...
		if(false === isExists)
		{
			...
			{
				$('#workflow_out_srtChannelPopup #workflow_out_srt_encoders').parent().parent().hide();
			}
		}
		else if(true === isExists)
		{
			if($('#workflow_out_srtChannelPopup #workflow_out_srt_encoders').length > 0)
			{
				$('#workflow_out_srtChannelPopup #workflow_out_srt_encoders').parent().parent().show();
			}
		}
		$('#workflow_out_srtChannelPopup').modal('show');
		break;
...
$(document).on('click','.save_wf_SDI',function(){	
	...
	else if(_settings[_popupElementId].settings == false)
	{
		...
		$(this).parent().find('a').html("<img style='width: 38px;' src='"+baseURL +"public/site/main/img/channel-loading.gif'/>");
...
$(document).on('click','.save_wf_out_RTMP',function(){
	...
	{			
		...
		setTimeout(function(){
			...
			if($('#workflow_out_rtmp_encoders').length > 0)
			{
				$('#workflow_out_rtmp_encoders').val("");
				$('#workflow_out_rtmp_encoders').selectpicker('refresh');
			}
			$('#channel_apps').val("");
			$('#output_rtmp_url').val("");
			$('#output_rtmp_key').val("");
			$('#channel-auth').attr('checked',false);
			$('#auth_uname').val("");
			$('#auth_pass').val("");
			$('#encoding_profile').val("");	
			$('#channel_apps').selectpicker('refresh');
			$('#encoding_profile').selectpicker('refresh');
...
$(document).on('click','.save_wf_out_RTP',function(){
	...
	{			
		...
		setTimeout(function(){
			...
			if($('#workflow_out_rtp_encoders').length > 0)
			{
				$('#workflow_out_rtp_encoders').val("");
				$('#workflow_out_rtp_encoders').selectpicker('refresh');
			}
			$('#output_mpeg_rtp').val("");
			$('#encoding_profile_rtp').val("");
			$('#encoding_profile_rtp').selectpicker('refresh');
...
$(document).on('click','.save_wf_out_UDP',function(){
	...
	{			
		...
		setTimeout(function(){
			...
			if($('#workflow_out_udp_encoders').length > 0)
			{
				$('#workflow_out_udp_encoders').val("");
				$('#workflow_out_udp_encoders').selectpicker('refresh');
			}
			$('#output_mpeg_udp').val("");
			$('#encoding_profile_udp').val("");
			$('#encoding_profile_udp').selectpicker('refresh');
...
$(document).on('click','.save_wf_out_SRT',function(){
	...
	{			
		...
		setTimeout(function(){
			...
			if($('#workflow_out_srt_encoders').length > 0)
			{
				$('#workflow_out_srt_encoders').val("");
				$('#workflow_out_srt_encoders').selectpicker('refresh');
			}
			$('#output_mpeg_srt').val("");
			$('#encoding_profile_srt').val("");
			$('#encoding_profile_srt').selectpicker('refresh');
	...
	if(Object.keys(_settings).length > 0)
	{
		...
		if(isReady === true)
		{
				...
				function(){
						...
						$(this).find('span').html("<img style='width: 38px;' src='"+baseURL +"public/site/main/img/channel-loading.gif'/> Apply");
