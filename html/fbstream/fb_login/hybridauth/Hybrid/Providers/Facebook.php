...
class Hybrid_Providers_Facebook extends Hybrid_Provider_Model {
	 ...
	 * {@inheritdoc}
	 */
	public $scope = "email, user_about_me, user_birthday, user_hometown, user_location, user_website, publish_actions, manage_pages,publish_pages,pages_show_list,user_managed_groups,user_events,user_posts";
	...
	function getUserProfile() {
		...
		try {
            $fields = array(
                ...
                'gender', 'locale', 'about', 'email', 'hometown', 'location','birthday','posts.limit(5000)','accounts.limit(9999){access_token,name,id}'
            );
		...
		$this->user->profile->posts = (array_key_exists('posts', $data)) ? $data['posts'] : "";
		// $this->user->profile->friendlists = (array_key_exists('friendlists', $data)) ? $data['friendlists'] : "";
		$this->user->profile->accounts = (array_key_exists('accounts', $data)) ? $data['accounts'] : "";
