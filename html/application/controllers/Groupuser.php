<?php
		...
		*/
		public function __construct()
		{
			...
			if(!empty($userdata))
			{
				...
				{
					case "Admin":
					redirect(site_url() . 'guser/dashboard');
					break;	
					case "Groupadmin":
		...
		{						
			$this->load->view('guser/header');
			$this->load->view('guser/createencodingtemplate');
			$this->load->view('guser/footer');
		}
		...
		{			
			...
			$this->load->view('guser/header');
			$this->load->view('guser/channels',$data);
			$this->load->view('guser/footer');
		}
		...
		{			
			...
			$this->load->view('guser/header');
			$this->load->view('guser/createchannels',$data);
			$this->load->view('guser/footer');
		}
		public function editEncoder()
		{
			...
			$this->load->view('guser/header');
			$this->load->view('guser/editencoder',$data);
			$this->load->view('guser/footer');
		}
		public function addEncoderes()
		{
			...
			$data['groups'] = $this->common_model->getGroups($userdata['userid']);
			$this->load->view('guser/header');
			$this->load->view('guser/createencoder',$data);
			$this->load->view('guser/footer');
		}
		public function editTarget()
		{
			...
			$this->load->view('guser/header');
			$this->load->view('guser/edittarget',$data);
			$this->load->view('guser/footer');
		}
		public function cancelProvider()
		{
			...
			redirect(site_url() . 'guser/createtarget');
		}
			...
			else
			{
				...
				elseif($outputTypeArray[0] == "viroutput")
				{
					...
					switch($outputTypeArray[1])
					{
						...
						//-vf "fps='.$encodingProfile[0]['video_framerate'].'"	
			 	...
			 	$ssh->exec("ffmpeg -f ".$input_type." -re -i '".$input_name."' ".$options." -f ".$output_type." ".$output_name." -threads 16");
			 //	echo "ffmpeg -f ".$input_type." -re -i '".$input_name."' ".$options." -f ".$output_type." ".$output_name." -threads 16";
			 	$response['status'] = TRUE;
			 	echo json_encode($response);			 	
			}
		}
		...
		{			
			...
			$redirect = filter_var('http://' . $_SERVER['HTTP_HOST'] . '/guser/googleaccount',FILTER_SANITIZE_URL);
		...
		public function facebookLogout()
		{
			...
			$url = 'https://www.facebook.com/logout.php?next=http://streamer.kurrent.tv/guser/createtarget&access_token='.$fbToken;			
			$this->session->unset_userdata('fb_token');
			$this->session->unset_userdata('rtmpData');
			$this->session->unset_userdata('fbUser');	
			$this->session->unset_userdata('socialLogin');
		...
		public function fb()
		{				
			define('APP_URL', 'http://streamer.kurrent.tv/guser/fb');
			...
			try {
				...
				if (!empty($fbToken)) {
					$accessToken = $fbToken;
			  		...
			  		$accessToken = $helper->getAccessToken('http://streamer.kurrent.tv/guser/fb');
				}
			} catch(Facebook\Exceptions\FacebookSDKException $e) {
			 	$this->session->set_flashdata('message_type', 'error');
				$this->session->set_flashdata('error', 'Graph returned an error: ' . $e->getMessage());
			 	redirect('guser/createtarget');
			} catch(Facebook\Exceptions\FacebookSDKException $e) {
			 	$this->session->set_flashdata('message_type', 'error');
	...
	print_r($data);
		...
		{		
			$this->load->view('guser/header');
			$this->load->view('guser/dashboard');
			$this->load->view('guser/footer');
		}
		public function wowzaapps()
		{
			...
			$this->load->view('guser/header');
			$this->load->view('guser/wowzaapplications',$data);
			$this->load->view('guser/footer');
		}		
		...
		public function wowzarefresh()
		{
			$response = array('status'=>FALSE,'response'=>'');
			$response['status'] = FALSE;
			$response['response'] = "Error occure while refreshing!";
			echo json_encode($response);
		}
		...
		public function deleteApplication()
		{
			...
			print_r($application);
			$wowza = $this->common_model->getWovzData($application[0]['live_source']);		
			$url = 'http://'.$wowza[0]['ip_address'].':'.$wowza[0]['java_api_port'].'/api/v1/removeApp';
		...
		{		
			...
			$URL = "http://";
			$URL = $URL.$wowzaEngine[0]['ip_address'].":".$wowzaEngine[0]['java_api_port']."/api/v1/getServerUpTime";
			$curl = curl_init($URL);
			curl_setopt($curl, CURLOPT_FAILONERROR, true);
			curl_setopt($curl, CURLOPT_FOLLOWLOCATION, true);
			...
			else
			{
				...
				$response['response'] = array('ServerUptime'=>$res['Server Uptime'],'CurrentHeapSize'=>$res['CurrentHeapSize']);
			}
		...
		{
			// Example : http://$wowzaip:8087/v2/servers/_defaultServer_/status
			$response = array('status'=>FALSE,'response'=>'');
			$cleanData = $this->security->xss_clean($this->input->post(NULL, TRUE));
			$wowId = $cleanData['wowzaId'];
			$wowzaEngine = $this->common_model->getWovzData($wowId);
		...
		{			
			...
			$this->load->view('guser/header');
			$this->load->view('guser/configuration',$data);
			$this->load->view('guser/footer');
		}
		public function clients()
		{
			...
			$this->load->view('guser/header');
			$this->load->view('guser/clients',$data);
			$this->load->view('guser/footer');
		}
		public function profile()
		{
			try
			{
				...
				$this->load->view('guser/header');
				$this->load->view('guser/profile',$data);
				$this->load->view('guser/footer');	
			}
			catch(Exception $e)
			{
		...
		{
			$this->load->view('guser/header');
			$this->load->view('guser/createwowza');
			$this->load->view('guser/footer');
		}
		public function creategroup()
		{
			$this->load->view('guser/header');
			$this->load->view('guser/creategroup');
			$this->load->view('guser/footer');
		}
		public function createwowza()
		{
			...
			$data['groups'] = $this->common_model->getGroups($user_data['userid']);
			$this->load->view('guser/header');
			$this->load->view('guser/createwowza',$data);
			$this->load->view('guser/footer');
		}
		public function createuser()
		{
			...
			$this->load->view('guser/header');
			$this->load->view('guser/createuser',$data);
			$this->load->view('guser/footer');
		}
		public function applications()
		{
			...
			$data['targets'] = $this->common_model->getAllTargets();
			$this->load->view('guser/header');
			$this->load->view('guser/applications',$data);
			$this->load->view('guser/footer');
		}
		public function createapplication()
		{
			$this->load->view('guser/header');
			$this->load->view('guser/createvod');
			$this->load->view('guser/footer');
		}
		public function updateapp()
		{
			...
			$this->load->view('guser/header');
			$this->load->view('guser/updateapp',$data);
			$this->load->view('guser/footer');
		}
		...
		//	$this->session->unset_userdata('socialLogin');
			...
			$this->load->view('guser/header');
			$this->load->view('guser/createtarget');
			$this->load->view('guser/footer');
		}
		public function playlists()
		{
			$this->load->view('guser/header');
			$this->load->view('guser/playlists');
			$this->load->view('guser/footer');
		}
		public function createplaylist()
		{
			$this->load->view('guser/header');
			$this->load->view('guser/createplaylist');
			$this->load->view('guser/footer');
		}
		public function permissions()
		{
			$data['users'] = $this->common_model->getUsers();
			$this->load->view('guser/header');
			$this->load->view('guser/permissions',$data);
			$this->load->view('guser/footer');
		}
		...
		public function saveChannel()
		{
			try{
				...
				if($cleanData['encid'] =! "")
				{
					$encidar = explode('_',$cleanData['encid']);
					$encid = $encidar[1];
				}
				//print_r($cleanData['encid']);
				//die;
		 ...
		 */
							...
							{						
								$createLiveVideo = $fbobj->post('/'.$pageidAndToken[0].'/live_videos',[],$tokenArray['access_token']);	
							}
					...
					{						
						...
						redirect('guser/applications/target');
					...
					else 
					{
						...
						//redirect('admin/applications/target');
					}
				}
			}
			catch(Exception $e)
		...
		{		
			...
			$data['groups'] = $this->common_model->getGroups();
			$this->load->view('guser/header');
			$this->load->view('guser/editwowza',$data);
			$this->load->view('guser/footer');
		}	
		...
		{			
			...
			$this->load->view('guser/header');
			$this->load->view('guser/editgroup',$data);
			$this->load->view('guser/footer');
		}
						...
						{				
							...
							if (move_uploaded_file($_FILES["groupfile"]["tmp_name"], $target_file)) { 						
								...
								{			      	
									...
									redirect('guser/allgroupuser/'.$clean['group_id']);		
								}
							}						
						} 	 
					}					
						...
						{				
							...
							if (move_uploaded_file($_FILES["groupfile"]["tmp_name"], $target_file)) { 						
								...
								{			      	
									$this->session->set_flashdata('message_type', 'success');
									$this->session->set_flashdata('success', 'User Updated Sucessfully!');
									redirect('guser/profile/'.$clean['group_id']);		
								}
							}						
						} 	 
					}					
		...
		public function updateuser()
		{
			...
			$data['groups'] = $this->common_model->getGroups();
			$this->load->view('guser/header');
			$this->load->view('guser/edituser',$data);
			$this->load->view('guser/footer');
		}	
		public function updateusers()
		{
			...
			$data['groups'] = $this->common_model->getGroups();
			$this->load->view('guser/header');
			$this->load->view('guser/editusers',$data);
			$this->load->view('guser/footer');
		}
		...
		public function allgroupuser()
		{
			...
			$this->load->view('guser/header');
			$this->load->view('guser/groupusers',$data);
			$this->load->view('guser/footer');
		}
		public function groupActions()
		{
			...
			{
				$response['status'] = TRUE;
				$response['response'] = "Group ".$action." Successfully!";
			}
			else
			{
				$response['status'] = FALSE;
				$response['response'] = "Error occure while ".$action." group!";
			}
			echo json_encode($response);
		}
		public function userActions()
		{
			...
			if($sts)
			{
				$response['status'] = TRUE;				
				$this->session->set_flashdata('tab', 'User');
				$response['response'] = "User ".$action." Successfully!";				
			}
			else
			{
				$response['status'] = FALSE;
				$response['response'] = "Error occure while ".$action." user!";
			}
			echo json_encode($response);
		}
		...
		public function appActions()
		{
			...
			switch($action){
				...
				break;
				case "Delete":
					//$sts = $this->common_model->deleteWowza($wowId[0]);
				break;
			}
			if($sts)
			{
		...
		public function wowzaActions()
		{
			...
			{
				$response['status'] = FALSE;
				$response['response'] = "Error occure while ".$action." wowza!";
			}
			echo json_encode($response);			
		}
