...
<section class="content-wrapper">
 ...
 <?php
	...
	<div class="content-box config-contentonly">
			...
			<form class="form-only form-one" method="post" action="<?php echo site_url();?>groupuser/saveTarget" enctype="multipart/form-data">
								...
								<div class="btns-dv">
									<div class="row">		
										    <div class="cc-selector">
										        <input id="visa" type="radio" name="target" value="facebook" />
										        <label class="drinkcard-cc visa" for="visa"></label>
										        <input id="mastercard" type="radio" name="target" value="youtube" />
