...
<?php $this->load->view('groupuser/leftsidebar.php');?>
  ...
  <!-- ========= Main Content Start ========= -->
	...
	<div class="content-box config-contentonly">
			<div class="row">
			<div class="col-xs-12">
               <div class="box-header wowza-box-header">
                 <div class="wowza-form" id="wowza_form">
			
			
			<form id="wowza-form" class="form-only form-one" method="post" action="<?php echo site_url();?>groupuser/saveConfiguration" enctype="multipart/form-data">
      ...
      <div class="row">
                                                    <div class="col-lg-4 col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="col-md-4 xxl-only pdright">
                                                    ...
                                                    <div class="col-lg-4 col-md-12">
                                                        ...
                                                        <div class="form-group margintop2">
                                                    ...
                                                    <div class="col-lg-4 col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="col-md-12 col-lg-4 xxl-only1 sml-marg pdright">
