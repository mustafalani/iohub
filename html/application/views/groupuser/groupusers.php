                              ...
                              <div class="box-body table-responsive no-padding">
                                 <table class="table table-hover check-input">
                                    ...
                                    <tr>
                                     ...
                                     <td><img width="20px" height="20px" src="<?php echo site_url();?>assets/site/main/group_pics/<?php echo $img[0]['name'];?>"/><a id="<?php echo $group['group_name']?>" href="<?php echo site_url();?>/groupuser/updategroup/<?php echo $group['id']?>"><?php echo $group['fname'].' '.$group['lname']?></a></td>

                                       <td><?php echo $group['email_id'];?></td>
                                       <td>
