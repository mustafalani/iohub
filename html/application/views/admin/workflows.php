...
<main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="<?php echo site_url();?>workflowlist">Workflows</a></li>
                                    ...
                                    <div class="row">
                                    	<div class="col-lg-12 col-md-12">
												...
												<div class="col-md-1 sav-btn-dv pull-right" style="padding-left:0;">
										             <button type="submit" class="btn-def save btn-primary float-right">
														<span>Apply</span>
													</button>
												</div>
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="inputs">
										    <div class="action-table">
										        <div class="row">
										            <div class="col-xs-12">
										              <div id="sdi" class="input_box btn btn-sm">SDI</div>
										              <div id="ndi" class="input_box btn btn-sm">NDI</div>
										              <div id="rtmp" class="input_box btn btn-sm">RTMP</div>
										              <div id="rtp" class="input_box btn btn-sm">RTP</div>
										              <div id="udp" class="input_box btn btn-sm">UDP</div>
										              <div id="srt" class="input_box btn btn-sm">SRT</div>
										            </div>
										        </div>
										    </div>
										</div>
										 <div role="tabpanel" class="tab-pane " id="outputs">
										    <div class="action-table">
										        <div class="row">
										            <div class="col-xs-12">
										              <div id="sdi" class="output_box btn btn-sm">SDI</div>
										              <div id="ndi" class="output_box btn btn-sm">NDI</div>
										              <div id="rtmp" class="output_box btn btn-sm">RTMP</div>
										              <div id="rtp" class="output_box btn btn-sm">RTP</div>
										              <div id="udp" class="output_box btn btn-sm">UDP</div>
										              <div id="srt" class="output_box btn btn-sm">SRT</div>
										 ...
										 <div role="tabpanel" class="tab-pane" id="routing">
										    <div class="action-table">
										        <div class="row">
										            <div class="col-xs-12">
										              <div id="gateway_inout" class="btn btn-sm gateway_box" style="max-width:unset;">Gateway</div>
										               <div id="publisher_inout" class="btn btn-sm publisher_box" style="max-width:unset;">Publisher</div>
										            </div>
										        </div>
										    </div>
										</div>
