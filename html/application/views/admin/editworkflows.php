                                ...
                                <div class="config-container">
                                    ...
                                    <div class="row">
                                    	<div class="col-lg-12 col-md-12">
												<div class="form-group col-md-6 pdleft">
													<input type="text" class="form-control" placeholder="Name" name="workflow_name" id="workflow_name" value="<?php echo $workflow[0][''];?>" />
												</div>
												<div class="col-md-1 sav-btn-dv pull-right" style="padding-left:0;">
										             <button type="button" class="btn-def save saveWorkflow">
														 <span>Update</span>
													</button>
												</div>
                                    ...
                                    <div class="tab-btn-container">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#inputs" aria-controls="channels" role="tab" data-toggle="tab">Inputs</a></li>
                                            <li role="presentation" ><a href="#outputs" aria-controls="channels" role="tab" data-toggle="tab">Outputs</a></li>
                                              <li role="presentation" ><a href="#routing" aria-controls="channels" role="tab" data-toggle="tab">Routing</a></li>
                                            <li role="presentation" ><a href="#targets" aria-controls="channels" role="tab" data-toggle="tab">Targets</a></li>
                                        </ul>
