...
<main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><?php echo $nebula[0]['encoder_name'];?></li>
      </ol>
      <div class="container-fluid">
      	<div class="animated fadeIn">
           <div class="card">

           	<form id="wowza-form" class="action-table" method="post" action="<?php echo site_url();?>admin/updateNebula/<?php echo $nebula[0]['id'];?>" enctype="multipart/form-data">

						 <div class="card-header">Edit Nebula</div>
				<div class="card-body">
      ...
      <input type="hidden" name="encoderId" id="encoderId" value="<?php echo $nebula[0]['id'];?>">
                	...
                	<div class="row">
                					<div class="col-lg-4 col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="encoder_name" id="encoder_name" class="form-control" value="<?php echo $nebula[0]['encoder_name'];?>" required="true">
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label>IP Address <span class="mndtry">*</span></label>
                                                                    <input type="text" class="form-control" id="encoder_ip" name="encoder_ip" value="<?php echo $nebula[0]['encoder_ip'];?>"  required="true">
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label>SSH Port <span class="mndtry">*</span></label>
                                                                    <input type="text" class="form-control" id="encoder_port" name="encoder_port" value="<?php echo $nebula[0]['encoder_port'];?>"  required="true">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input type="text" class="form-control" placeholder="Admin"  id="encoder_uname" name="encoder_uname" value="<?php echo $nebula[0]['encoder_uname'];?>"  required="true">
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label>Password <span class="mndtry">*</span></label>
                                                                    <input type="password" class="form-control" id="encoder_pass" name="encoder_pass" value="<?php echo $nebula[0]['encoder_pass'];?>"  required="true">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
												...
												<input type="text" name="parh_setting" id="parh_setting" class="form-control" required="true" value="<?php echo $nebula[0]['parh_setting']; ?>"/>
														</div>
                                                        <div class="form-group">
                                                            <div class="row">
                                                            	<?php
                                                                            ...
                                                                            <select class="form-control selectpicker" name="encoder_group" id="encoder_group">
                                                                                ...
                                                                                <?php
																					if(sizeof($groups)>0)
																					{
																						...
																						{
																							if($nebula[0]['encoder_group'] == $group['id'])
																							{
																							?>
  ...
  <div class="col-lg-4 col-md-12">
											        <div class="form-group">
                                                        <label>Gateway Encoder ID <span class="mndtry"></span></label>
                                                        	                                                            							<input type="text" readonly="true" class="form-control yellow"  value="<?php echo $nebula[0]['encoder_id'];?>"/>
                                                    </div>
                                                     <div class="form-group">
                                                        <label>Pair Token</label>
                                                         <?php
                                                    if($nebula[0]['paired'] == 1)
                                                    {
                                                    	?>
                                                    	<input type="text" readonly="true" class="form-control yellow pairingtext"  placeholder="Not-Paired" value="<?php echo $nebula[0]['pairID'];?>"/>
                                                    	<?php
													}
													else
													{
                                                    ...
                                                    {
                                                    	?>
                                                    	<a href="javascript:void(0);"  id="<?php echo $nebula[0]['encoder_id'];?>_unpair" class="btn gr pairing_gateway_encoder">Unpair <span></span></a>
                                                    	<?php
													}
													else
													{
														?>
                                                    	<a  href="javascript:void(0);" id="<?php echo $nebula[0]['encoder_id'];?>_pair" class="btn rd pairing_gateway_encoder">Pair<span></span></a>
                                                    	<?php
													}
                                                    ?>
...
<div class="col-xs-6 col-md-12 text-center">
                ...
                <br/>
                <?php $host = "http://".$nebula[0]['encoder_ip'].":19999";
