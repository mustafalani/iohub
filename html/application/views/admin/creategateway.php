...
<main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">New NDI Gateway</li>
      </ol>
      <div class="container-fluid">
      	<div class="animated fadeIn">
           <div class="card">
           	<form id="wowza-form" class="action-table" method="post" action="<?php echo site_url();?>admin/saveGateway" enctype="multipart/form-data">
           
             <div class="card-header">Add NDI Gateway</div>
				<div class="card-body">
