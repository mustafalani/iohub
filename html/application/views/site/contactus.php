...
<div class="container" style="float:none;height:38px;margin:0 auto;text-align: left;padding:0 16px;">
	...
	<div  class="container" style="min-height:502px;padding-top:10px;">
      ...
      <div class="lft">
		...
		<b class="hd">INDIAN COUNCIL FOR CULTURAL RELATIONS </b>		
		<label style="font-size:25px;" class="hd">ICCR (HEADQUARTER), DELHI </label>
		<p style="font-size:14px;">Email : <b>scholarship.iccr@gov.in</b></p>
		</span>
		<br/>
		<div id="myCarousel" class="carousel slide" data-ride="carousel" style="float:left;margin-right:12px;max-height:313px;width:40%;">
			<div class="carousel-inner" role="listbox">
			
			<div class="item active">
			  <img class="first-slide" src="<?php echo base_url();?>public/site/main/images/bg/bg1.png" alt="ICCR Banner" />
			</div>
			
				
			<!--<div class="item ">
			  <img class="second-slide" src="<?php echo base_url();?>public/site/main/images/bg/bg2.png" alt="ICCR  Banner" />
			</div>-->
			<div class="item">
			  <img class="second-slide" src="<?php echo base_url();?>public/site/main/images/bg/bg.png" alt="ICCR  Banner" />
			</div>
			</div>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d56035.78163841422!2d77.2310811!3d28.6226776!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xcf6a7c9b6a4be178!2sI.+C.+C.+R.+Azad+Bhavan!5e0!3m2!1sen!2sin!4v1494568307997" style="height:300px;width:59%;border:1px solid orange;padding:5px;float:left;" frameborder="0" allowfullscreen></iframe>
