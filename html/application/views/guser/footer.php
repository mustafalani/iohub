	...
	$('.nav-tabs li a').click(function(){
		...
		if(tabid != "" && tabid != 'undefined')
		{
			switch(tabid)
			{
				...
				break;
				case "groups":
				window.history.pushState({}, "Admin | Groups",  baseURL + 'admin/clients/' + tabid);
				break;
				case "users":
				window.history.pushState({}, "Admin | Users",  baseURL + 'admin/clients/' + tabid);
				break;
				case "permissions":
				window.history.pushState({}, "Admin | Permissions",  baseURL + 'admin/clients/' + tabid);
				break;
				case "wowza":
				window.history.pushState({}, "Admin | Configuration",  baseURL + 'admin/configuration/' + tabid);
				break;
				case "system":
				window.history.pushState({}, "Admin | Configuration",  baseURL + 'admin/configuration/' + tabid);
				break;
