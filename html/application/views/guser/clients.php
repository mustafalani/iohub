										...
										<div class="row">
											<div class="col-xs-12">
												...
												<div class="box-header">
													...
													<button type="button" class="btn btn-default submit" onclick="submitAllGroups('admin/groupActions');">Submit</button>
													<a href="<?php echo site_url();?>admin/creategroup" class="add-btn">
																	...
																	<?php
																		...
																		if(sizeof($groups)>0)
																		{
																			...
																			<tr>
																				...
																				?>
																				<a id="<?php echo $group['group_name']?>" href="<?php echo site_url();?>/admin/updategroup/<?php echo $group['id']?>"><?php echo $group['group_name']?></a></td>
																				...
																				<td><a href="<?php echo site_url();?>admin/allgroupuser/<?php echo $group['id'];?>"><br> Show all users</a></td>																				
																				<td>
											...
											<div class="row">
												<div class="col-xs-12">
													...
													<div class="box-header">
														...
														<button type="button" class="btn btn-default submit" onclick="submitAllUser('admin/userActions');">Submit</button>
																	...
																	<?php
																		...
																		{																			
																			...
																			<tr>
																				...
																				<td><img class="img-circle" src="<?php echo site_url();?>assets/site/main/group_pics/<?php echo $img1[0]['name'];?>"/><a id="<?php echo $usr['fname'].' '.$usr['lname'];?>" href="<?php echo site_url();?>/admin/updateuser/<?php echo $usr['id']?>"> <?php echo $usr['fname'].' '.$usr['lname'];?></td>
																					<td>
