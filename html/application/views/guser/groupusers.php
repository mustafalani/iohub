																...
																<?php
																	if(sizeof($groupsUsers)>0)
																	{
																		...
																		<tr>
																			...
																			<td><img width="20px" height="20px" src="<?php echo site_url();?>assets/site/main/group_pics/<?php echo isset($img[0]['name'])?$img[0]['name']:"";?>"/><a id="<?php echo $group['id']?>" href="<?php echo site_url();?>admin/updateuser/<?php echo $group['id']?>"><?php echo $group['fname'].' '.$group['lname']?></a></td>
