                                             ...
                                             <tbody>
                                                ...
                                                <tr>
                                             	...
                                             	<td><?php echo $counter;?></td>
                                                   ...
                                                   </strong> See Targets<br><a href="<?php echo site_url();?>admin/createtarget"><i class="fa fa-plus"></i> Add Target</a></td>
                                          ...
                                          <table class="table table-hover check-input targetTable">
                                             <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><a href="<?php echo site_url();?>admin/editTarget/<?php echo $target['id']?>"><?php echo $target['target_name'];?></a></td>
