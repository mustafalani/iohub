			...
			<div class="content">
				...
				<div class="content-box config-contentonly">
					<div class="row">
						...
						<form id="wowza-form" class="form-only form-one" method="post" action="<?php echo site_url();?>admin/updatesUsersdetails" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<select class="form-control select" name="role_id" id="role_id" disabled>
											...
											<?php if(!empty($groupuser)){?>
												...
												<option value="1" selected="selected"><?php if($groupuser[0]['role_id'] == '1'){echo "Admin";}?></option>
