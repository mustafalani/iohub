							...
							<?php 
							 ...
							 <div class="form-group col-lg-10">
                                ...
                                <div class="btns-dv">
                                 <a class="btn btn-facebook btn-sm btndis">
                                    ...
                                    <a class="btn btn-google btn-sm " href="<?php echo site_url();?>admin/googleaccount">
                                        <i class="fa fa-youtube"></i>
                                            Youtube Live
                                    </a>
                                    <a class="btn btn-twitch btn-sm btndis">
							 ...
							 <div class="form-group col-lg-10">
                                ...
                                <div class="btns-dv">
                                 <a class="btn btn-facebook btn-sm btndis">
                                    ...
                                    <a class="btn btn-twitch btn-sm " href="<?php echo site_url();?>admin/twitch">
                                        <i class="fa fa-twitch"></i>
                                            Twitch
                                    </a>                                         
                                    <a class="btn btn-twitter btn-sm btndis">
		                     ...
		                     <div class="form-group col-lg-9">
                                ...
                                <div class="btns-dv">
                                        ...
                                        <a class="btn btn-microsoft btn-sm " href="<?php echo site_url();?>admin/akamai">
                                            <i class="fa fa-cloud"></i>
                                                Akamai
                                        </a>
                                        <a class="btn btn-openid btn-sm btndis">
		                     ...
		                     <div class="form-group col-lg-9">
                                ...
                                <div class="btns-dv">
                                        ...
                                        <a class="btn btn-openid btn-sm " href="<?php echo site_url();?>admin/cloudfront">
                                            <i class="fa fa-amazon"></i>
                                                CloudFront
                                        </a>                                                                                                                      
                                    </div>
		                     ...
		                     <div class="form-group col-lg-10">
                                ...
                                <span><p class="fa fa-gear"></p> Generic</span>
                                <div class="btns-dv">
                                        <a class="btn  btn-microsoft btn-sm " href="<?php echo site_url();?>admin/wowzaengine">
                                            <i class="fa fa-gear"></i>
                                                Wowza Engine
                                        </a>
                                        <a class="btn btn-github btn-sm btndis">
		                     ...
		                     <div class="form-group col-lg-10">
                                ...
                                <div class="btns-dv">
                                        ...
                                        <a class="btn btn-github btn-sm " href="<?php echo site_url();?>admin/limelight">
                                            <i class="fa fa-gear"></i>
                                                Limelight
                                        </a>
                                        <a class="btn btn-github btn-sm btndis">
