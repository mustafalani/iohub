...
?>
  ...
  <!-- ========= Main Content Start ========= -->
	...
	?>
			...
			<div class="row">
				<form id="wowza-form" class="form-only form-one" method="post" action="<?php echo site_url();?>groupadmin/updateGroupDetails/<?php echo $this->uri->segment(3);?>" enctype="multipart/form-data">
