               ...
               <div class="col-xs-12">
                ...
                <div class="box-header">
                     <div class="wowza-form" id="wowza_form">
                        <form class="form-only form-one" method="post" action="<?php echo site_url();?>groupadmin/updateApplication/<?php echo $this->uri->segment(3);?>" enctype="multipart/form-data">
