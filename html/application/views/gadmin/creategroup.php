			...
			<div class="row">
				<div class="col-lg-12 col-12-12">
					<div class="content-box config-contentonly">
						<form id="wowza-form" class="action-table" method="post" action="<?php echo site_url();?>groupadmin/saveGroup" enctype="multipart/form-data">
							...
							<div class="col-lg-8 pref">
								...
								<div class="row">
									<div class="col-lg-7 cat margintop">
										<label>groupadmins</label><br>
										<a href="javascript:void(0);">2 Show groupadmins</a><br>
										<a href="javascript:void(0);"><i class="fa fa-plus"></i> Add New groupadmin</a>
										<br>
