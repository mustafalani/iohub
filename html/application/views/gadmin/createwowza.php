...
<?php $this->load->view('gadmin/leftsidebar.php');?>
  ...
  <!-- ========= Main Content Start ========= -->
      ...
      <div class="row action-table">
                                                    ...
                                                    <div class="col-lg-4 col-md-12">
                                                        <div class="form-group">
                                                            <label>WSE groupadministrator User Name <span class="mndtry">*</span></label>
                                                            <input type="text" class="form-control" placeholder="group admin"  name="wse_administrator_username" id="wse_administrator_username" required="true">
                                                        </div>

                                                        <div class="form-group">
                                                            <label>WSE groupadministrator Password</label>
