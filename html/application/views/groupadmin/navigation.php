                ...
                <div class="navbar-custom-menu topbarRight">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <span class="">Group Admin </span><i class="fa fa-caret-down" aria-hidden="true"></i>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="<?php echo site_url();?>groupadmin/profile" class="btn btn-default btn-flat">Profile</a>
                                    </div>
