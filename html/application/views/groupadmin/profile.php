    ...
    <div class="well">
      <div class="tab-content">
		...
		<div class="tab-pane fade in active" id="tab1" style="overflow:hidden;"> 
			<div class="dateof-birth col-xs-12 col-sm-12 col-md-12 pdleft pdright">
				...
				<div class="col-xs-3 col-sm-3 col-md-3 pdleft pdright">
					...
					<a class="btn-def save" href="<?php echo site_url().'groupadmin/updateuser/'.$userProfileData[0]['id'];?>" style="float:left;">Edit User</a>
					
				</div>	
			</div>	
			<div class="dateof-birth col-xs-12 col-sm-12 col-md-12 pdleft pdright"></div>
			<div class="dateof-birth col-xs-12 col-sm-12 col-md-12 pdleft pdright"></div>
			<div class="dateof-birth col-xs-12 col-sm-12 col-md-12 pdleft pdright"></div>
		</div>
		...
		<div class="tab-pane fade in" id="tab3" style="overflow:hidden;">
			<form id="wowza-form" class="form-only form-one profile-tab" method="post" action="<?php echo site_url();?>groupadmin/changePasswordSubmit" enctype="multipart/form-data">
