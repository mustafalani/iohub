    ...
    $.widget("flowchart.flowchart", {
        ...
        console.log(linkDataOriginal);
			...
			else
			{
      		...
      		//if(linksFromArray[1] == "Output" && linksToArray[1] == "Output")
      		//{
				//toastr['error']('You cant add link between Output to Output');
				//return;
			//} 
        ...
        _getOperatorFullElement: function (operatorData) {
			...
			if(ids[1] == "input")
			{
				...
				$operator_title.html(infos.title + ' <a href="javascript:void(0);" onclick=workflow_settings("input_'+ids[2].trim()+'");><i class="fa fa-cogs" aria-hidden="true"></i></a>');
			}
			else if(ids[1] == "output")
			{
				var $operator = $('<div id="'+infos.name+'" class="flowchart-operator outputbox"></div>');
				$operator_title.html(infos.title + ' <a href="javascript:void(0);" onclick=workflow_settings("output_'+ids[2].trim()+'");><i class="fa fa-cogs" aria-hidden="true"></i></a>');
			}
			else if(ids[1] == "gateway")
			{
				var $operator = $('<div id="'+infos.name+'" class="flowchart-operator gatewaybox"></div>');
				$operator_title.html(infos.title + ' <a href="javascript:void(0);" onclick=workflow_settings("gateway_'+ids[2].trim()+'");><i class="fa fa-cogs" aria-hidden="true"></i></a>');
			}
			else if(ids[1] == "publisher")
			{
				var $operator = $('<div id="'+infos.name+'" class="flowchart-operator publisherbox"></div>');
				$operator_title.html(infos.title + ' <a href="javascript:void(0);" onclick=workflow_settings("publishers_'+ids[2].trim()+'");><i class="fa fa-cogs" aria-hidden="true"></i></a>');
			}
			else if(ids[1] == "facebook")
			{
				var $operator = $('<div id="'+infos.name+'" class="flowchart-operator facebookbox"></div>');
				$operator_title.html('<i class="fa fa-facebook"></i> ' + infos.title + ' <a href="javascript:void(0);" onclick=workflow_settings("TRG_'+ids[2].trim()+'");><i class="fa fa-cogs" aria-hidden="true"></i></a>');
			}
			else if(ids[1] == "youtube")
			{
				var $operator = $('<div id="'+infos.name+'" class="flowchart-operator youtubebox"></div>');
				$operator_title.html('<i class="fa fa-youtube"></i> ' + infos.title + ' <a href="javascript:void(0);" onclick=workflow_settings("TRG_'+ids[2].trim()+'");><i class="fa fa-cogs" aria-hidden="true"></i></a>');
			}
			else if(ids[1] == "twitch")
			{
				var $operator = $('<div id="'+infos.name+'" class="flowchart-operator twitchbox"></div>');
				$operator_title.html('<i class="fa fa-twitch"></i> ' + infos.title + ' <a href="javascript:void(0);" onclick=workflow_settings("TRG_'+ids[2].trim()+'");><i class="fa fa-cogs" aria-hidden="true"></i></a>');
			}
			else if(ids[1] == "twitter")
			{
				var $operator = $('<div id="'+infos.name+'" class="flowchart-operator twitterbox"></div>');
				$operator_title.html('<i class="fa fa-twitter"></i> ' + infos.title + ' <a href="javascript:void(0);" onclick=workflow_settings("TRG_'+ids[2].trim()+'");><i class="fa fa-cogs" aria-hidden="true"></i></a>');
			}
			else if(ids[1] == "wowzacdn")
			{
				var $operator = $('<div id="'+infos.name+'" class="flowchart-operator wowzacdnbox"></div>');
				$operator_title.html('<i class="fa fa-cloud"></i> ' + infos.title + ' <a href="javascript:void(0);" onclick=workflow_settings("TRG_'+ids[2].trim()+'");><i class="fa fa-cogs" aria-hidden="true"></i></a>');
			}
			else if(ids[1] == "TRGRTMP")
			{
				var $operator = $('<div id="'+infos.name+'" class="flowchart-operator TRG_RTMPbox"></div>');
				$operator_title.html('<i class="fa fa-gear"></i> ' + infos.title + ' <a href="javascript:void(0);" onclick=workflow_settings("TRG_'+ids[2].trim()+'");><i class="fa fa-cogs" aria-hidden="true"></i></a>');
			}
