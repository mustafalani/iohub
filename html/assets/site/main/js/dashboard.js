...
(function(window, document, $, undefined) {
   ...
   // NETDATA.jQuery              = baseURL + 'assets/site/main/js/netdata/lib/jquery-2.2.4.min.js';
    NETDATA.peity_js            = baseURL + 'assets/site/main/js/netdata/lib/jquery.peity-3.2.0.min.js';
    NETDATA.sparkline_js        = baseURL + 'assets/site/main/js/netdata/lib/jquery.sparkline-2.1.2.min.js';
    NETDATA.easypiechart_js     = baseURL + 'assets/site/main/js/netdata/lib/jquery.easypiechart-97b5824.min.js';
    NETDATA.gauge_js            = baseURL + 'assets/site/main/js/netdata/lib/gauge-1.3.2.min.js';
    NETDATA.dygraph_js          = baseURL + 'assets/site/main/js/netdata/lib/dygraph-c91c859.min.js';
    NETDATA.dygraph_smooth_js   = baseURL + 'assets/site/main/js/netdata/lib/dygraph-smooth-plotter-c91c859.js';
    NETDATA.raphael_js          = baseURL + 'assets/site/main/js/netdata/lib/raphael-2.2.4-min.js';
    NETDATA.c3_js               = baseURL + 'assets/site/main/js/netdata/lib/c3-0.4.18.min.js';
    NETDATA.c3_css              = baseURL + 'assets/site/main/js/netdata/css/c3-0.4.18.min.css';
    NETDATA.d3pie_js            = baseURL + 'assets/site/main/js/netdata/lib/d3pie-0.2.1-netdata-3.js';
    NETDATA.d3_js               = baseURL + 'assets/site/main/js/netdata/lib/d3-4.12.2.min.js';
    NETDATA.morris_js           = baseURL + 'assets/site/main/js/netdata/lib/morris-0.5.1.min.js';
    NETDATA.morris_css          = baseURL + 'assets/site/main/js/netdata/css/morris-0.5.1.css';
    NETDATA.google_js           = 'https://www.google.com/jsapi';

    NETDATA.themes = {
        white: {
            bootstrap_css: baseURL + 'assets/site/main/js/netdata/css/bootstrap-3.3.7.css',
            dashboard_css: baseURL + 'assets/site/main/css/dashboard.css',
            background: '#FFFFFF',
            foreground: '#000000',
            grid: '#F0F0F0',
            axis: '#F0F0F0',
        ...
        slate: {
            //bootstrap_css: baseURL + 'assets/site/main/js/netdata/css/bootstrap-slate-flat-3.3.7.css',
            dashboard_css: baseURL + 'assets/site/main/js/netdata/css/dashboard.slate.css',
            background: '#272b30',
            foreground: '#C8C8C8',
            grid: '#283236',
            axis: '#283236',
