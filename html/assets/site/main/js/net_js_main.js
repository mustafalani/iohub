...
function playTargetRTMP(src,pid) {
    ...
    {
		swfobject.embedSWF(baseURL + 'assets/site/main/js/GrindPlayer.swf', pid, '100%', '386', '10.2', null, flashvars, params, attributes);
	}
	else
	{
		swfobject.embedSWF(baseURL + 'assets/site/main/js/GrindPlayer.swf', pid, '100%', '300', '10.2', null, flashvars, params, attributes);	
	}
...
function playRTMP(src,pid) {
    ...
    if(Action == "editTarget")
    {
		swfobject.embedSWF(baseURL + 'assets/site/main/js/GrindPlayer.swf', pid, '100%', '405', '10.2', null, flashvars, params, attributes);
	}
	else
	{
		swfobject.embedSWF(baseURL + 'assets/site/main/js/GrindPlayer.swf', pid, '100%', '300', '10.2', null, flashvars, params, attributes);	
